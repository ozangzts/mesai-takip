...
Faz 1 çalışıyor, üç ay üretiliyor, 163 test geçiyor.
...
1. **Proje sahibi GUI'yi kendi makinesinde deneyecek.** Geri bildirim bekleniyor —
   özellikle klasör seçimindeki dosya listesi ve Temmuz'daki turuncu uyarı.
